...
const Checkout = ({ cart, order, error, onCaptureCheckout, refreshCart }) => {
    ...
    let Confirmation = () => order.customer ? (
        <>
            <div>
                <Typography variant='h5'>Thank you for your purchase. {order.customer.firstname} {order.customer.lasname}</Typography>
        ...
        <div>
            ...
            <Divider className={classes.divider}/>
            <Typography variant='subtitle2'>Order ref: 1231412</Typography>
        </div>
        <br />
        <Button component={Link} to='/' variant='outlined' type='button'>Back to Home</Button>
        </>
